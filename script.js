...
const API_KEY = "fc6d93b83ff51a2a54ab2a7c48c994b9";
setInterval(() => {
  const time = new Date();
...
function loadUsers() {
  ...
  weather.open(
    "GET",
    "http://api.ipstack.com/access_key = 9b9d6f4a3527077ba4354101986d0a55"
  );
  weather.send(null);
  ...
  var dis =
    "Current location: " +
    r.current_observation.display_location.full +
    "  <p>";
